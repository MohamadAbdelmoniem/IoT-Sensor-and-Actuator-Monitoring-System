...
C_SRCS += \
../libs/cJSON/tests/unity/src/unity.c 

C_DEPS += \
./libs/cJSON/tests/unity/src/unity.d 

OBJS += \
./libs/cJSON/tests/unity/src/unity.o 


# Each subdirectory must supply rules for building sources it contributes
libs/cJSON/tests/unity/src/%.o: ../libs/cJSON/tests/unity/src/%.c libs/cJSON/tests/unity/src/subdir.mk
	@echo 'Building file: $<'
