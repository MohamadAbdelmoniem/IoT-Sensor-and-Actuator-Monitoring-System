...
C_SRCS += \
../libs/cJSON/tests/unity/examples/example_3/helper/UnityHelper.c 

C_DEPS += \
./libs/cJSON/tests/unity/examples/example_3/helper/UnityHelper.d 

OBJS += \
./libs/cJSON/tests/unity/examples/example_3/helper/UnityHelper.o 


# Each subdirectory must supply rules for building sources it contributes
libs/cJSON/tests/unity/examples/example_3/helper/%.o: ../libs/cJSON/tests/unity/examples/example_3/helper/%.c libs/cJSON/tests/unity/examples/example_3/helper/subdir.mk
	@echo 'Building file: $<'
