...
C_SRCS += \
../libs/cJSON/tests/unity/test/tests/testparameterized.c \
../libs/cJSON/tests/unity/test/tests/testunity.c 

C_DEPS += \
./libs/cJSON/tests/unity/test/tests/testparameterized.d \
./libs/cJSON/tests/unity/test/tests/testunity.d 

OBJS += \
./libs/cJSON/tests/unity/test/tests/testparameterized.o \
./libs/cJSON/tests/unity/test/tests/testunity.o 


# Each subdirectory must supply rules for building sources it contributes
libs/cJSON/tests/unity/test/tests/%.o: ../libs/cJSON/tests/unity/test/tests/%.c libs/cJSON/tests/unity/test/tests/subdir.mk
	@echo 'Building file: $<'
