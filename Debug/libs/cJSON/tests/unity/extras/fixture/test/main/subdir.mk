...
C_SRCS += \
../libs/cJSON/tests/unity/extras/fixture/test/main/AllTests.c 

C_DEPS += \
./libs/cJSON/tests/unity/extras/fixture/test/main/AllTests.d 

OBJS += \
./libs/cJSON/tests/unity/extras/fixture/test/main/AllTests.o 


# Each subdirectory must supply rules for building sources it contributes
libs/cJSON/tests/unity/extras/fixture/test/main/%.o: ../libs/cJSON/tests/unity/extras/fixture/test/main/%.c libs/cJSON/tests/unity/extras/fixture/test/main/subdir.mk
	@echo 'Building file: $<'
